...
### Transaction structure
  ...
  Element name     |          Element type  |  Optional |  Description
--------------------|-----------------------|-----------|----------------
  CommandID  |        xsd:string |     No   |      The unique identifier of transaction/business operation. Max length is 64.e <ul><li>*SalaryPayment*</li><li> *BusinessPayment*</li><li>*BusinessPaymentWithWithdrawalChargePaid*</li><li>*SalaryPaymentWithWithdrawalChargePaid*</li><li>*PromotionPayment*</li><li>*TransferFromBankToCustomer*</li><ul>
  LanguageCode |              xsd:string |     Yes    |    It indicates language. It’s reserved.
  OriginatorConversationID|   xsd:string  |    No    |     The unique identifier of the request message generated by third party. It is used to identify a request between the third party and MM. Max length is 128.    Field must start with the B2C organisation short and name of organisation. Eg.232323\_KCBOrg\_XXXXXX   XXXXX must be unique for every transaction.
